...
class PhotoView @JvmOverloads constructor(
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@PhotoView.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@PhotoView.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            (this@PhotoView.context as Activity).finish()
        }
...
//                }
    ...
    /**
     * Opens the camera specified by [PhotoView.cameraId].
     */
    ...
    override val fileSaved: Observable<File> get() = fileSavedSubject.hide()
